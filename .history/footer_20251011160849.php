<?php
// Разрешаем SVG и его атрибуты для wp_kses
function custom_kses_allowed_html($tags) {
  $tags['svg'] = [
    'width' => true,
    'height' => true,
    'viewBox' => true,
...
add_filter('wp_kses_allowed_html', 'custom_kses_allowed_html', 10, 1);
?>
