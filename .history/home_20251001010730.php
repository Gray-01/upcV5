...
<?php get_header(); ?>
  ...
  <main class="main">
    ...
    <section class="hero">
      ...
      <img class="hero__img" src="assets/<?php echo get_template_directory_uri(); ?>/assets/images/baner.png" alt="banner">
  ...
  <section class="news">
    ...
    <div class="container">
      ...
      <div class="news__image-wrapper">
        <img class="news__img" src="assets/<?php echo get_template_directory_uri(); ?>/assets/images/news-img.jpg" alt="Громада УПЦ">
      </div>
    </div>
  ...
  <section class="announcements">
    ...
    <ul class="announcements__list">
      <li class="announcement__item">
        <img class="announcement__img" src="assets/<?php echo get_template_directory_uri(); ?>/assets/images/announcements-1.png" alt="Святкування Великодня 2025">
      ...
      <li class="announcement__item">
        <img class="announcement__img" src="assets/<?php echo get_template_directory_uri(); ?>/assets/images/announcements-2.jpg" alt="Благодійна акція">
      ...
      <li class="announcement__item">
        <img class="announcement__img" src="assets/<?php echo get_template_directory_uri(); ?>/assets/images/announcements-3.jpg" alt="Паломництво до Почаєва">
    ...
    <div class="container school__container">
      ...
      <div class="school__content">
        ...
        <div class="school__image-wrap">
          <img src="assets/<?php echo get_template_directory_uri(); ?>/assets/images/gallery/1.png" alt="Недільна школа" class="school__image" id="openGallery">
  ...
  <div class="gallery" id="galleryModal">
    ...
    <div class="gallery__content">
      ...
      <img class="gallery__img" id="galleryImage" src="assets/<?php echo get_template_directory_uri(); ?>/assets/images/gallery/1.png" alt="">
