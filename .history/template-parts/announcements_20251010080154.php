<section class="announcements">
  ...
  <ul class="announcements__list">
    <li class="announcement__item">
      ...
      <p class="announcement__desc">Детальний розклад святкових богослужінь...</p>
    ...
    <li class="announcement__item">
      ...
      <p class="announcement__desc">Цієї неділі в нашій недільній школі...</p>
      <a href="#" class="announcement__link">Читати далі</a>
    </li>
    ...
    <li class="announcement__item">
      ...
      <p class="announcement__desc">Сьогодні на заняттях наші дітки співали...</p>
      <a href="#" class="announcement__link">Читати далі</a>
    </li>
  </ul>
