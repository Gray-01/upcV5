...
echo '<h1 style="color:red;text-align:center;margin-top:100px;">ШАБЛОН CATEGORY-PILGRIMAGE.PHP ПОДКЛЮЧЕН</h1>';
exit;
      ...
      <?php if (have_posts()) : ?>
        <?php while (have_posts()) : the_post(); ?>
          <div class="pilgrimage__card">
            ...
            <a href="<?php the_permalink(); ?>" class="pilgrimage__link">читати далі</a>
          </div>
        <?php endwhile; ?>
      <?php else : ?>
