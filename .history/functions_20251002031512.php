...
class Upcv5_Walker_Nav_Menu extends Walker_Nav_Menu {
    ...
    function start_el(&$output, $item, $depth=0, $args=[], $id=0) {
        ...
        // Получаем ACF-поля для пункта меню
        ...
        // Проверяем наличие дочерних элементов безопасно
        $has_children = (isset($args->has_children) && $args->has_children) ? ' nav__has-submenu' : '';

        // Вывод li и ссылки
        $output .= '<li class="nav__item' . $has_children . '">';
