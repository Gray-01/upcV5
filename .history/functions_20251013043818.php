...
// 20251013_start
// 20251013 — Регистрируем мобильное меню (дополнительное)
function upcv5_register_mobile_menu() {
    register_nav_menu('mobile_menu', __('Mobile Menu', 'upcv5'));
}
add_action('after_setup_theme', 'upcv5_register_mobile_menu');
